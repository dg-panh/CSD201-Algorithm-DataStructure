...
public class Validation {
    ...
    public static String getDateFormat(String inputMsg, String errorMsg, String format, String lowerBound, Date upperBound) { //nang cap thanh try catch nhieu tang 
        ...
        while (true) {
            try {
                ...
                if (date.before(dateLower) || date.after(upperBound)) {
                    throw new Exception();
                }
                ...
                System.out.println("Date must be from " + lowerBound + " to " + formatter.format(upperBound));
            }
        }
    }
